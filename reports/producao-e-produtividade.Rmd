...
Como um resultado prático, nós pudemos observar que, a quantidade de docentes permanentes, em programas de pós graduação no Brasil em computação, tem uma forte relação com a produtividade do programa. Na prática, essa relação nos permite destacar que os programas que contém uma maior quantidade de docentes permanentes também vão apresentar uma maior produtividade. Isso nós permite imaginar um palpite do por quê dessa relação ser forte. Nós acreditamos que, os programas que possuem uma maior quantidade de docentes permanentes também são os programas que mais contém profissionais engajados na carreira de pesquisador. Esse engajamento funciona como uma engrenagem propulsora para o aumento da produtividade dos programas. Contudo, está é apenas uma hipótese anédota que nós não investigamos.
